...
#define GET_ORIGINAL(FUNC_NAME) CAT3(orig, FUNC_NAME, FUNC_POSTFIX)

#define GET_ORIGINAL_NONTYPED(FUNC_NAME) ((void *)GET_ORIGINAL(FUNC_NAME))
...
#define SET_ORIGINAL(FUNC_NAME, PTR) GET_ORIGINAL(FUNC_NAME) = PTR
...
#define GET_PAYLOAD(FUNC_NAME) CAT3(payloaded, FUNC_NAME, FUNC_POSTFIX)
